...
import { ChevronDown, Heart, LogOut, MapPin, Settings, User } from "lucide-react"
      ...
      <DropdownMenuContent className="w-52">
        ...
        <DropdownMenuGroup>
          <DropdownMenuItem className="cursor-pointer">
            <Link href={"/settings/account-details"} className="flex gap-2 items-center">
              <User />
          ...
          <DropdownMenuItem className="cursor-pointer">
            <Link href={"/settings/address"} className="flex gap-2 items-center">
              <MapPin />
              <span>Address</span>
            </Link>
          </DropdownMenuItem>
          ...
          <DropdownMenuItem className="cursor-pointer">
            <Link href={"/settings/wishlist"} className="flex gap-2 items-center">
              <Heart />
              <span>Wishlist</span>
            </Link>
          </DropdownMenuItem>
